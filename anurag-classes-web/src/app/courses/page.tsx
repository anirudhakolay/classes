        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-12">
            {courses.map((c, i) => (
              ...
              <motion.div {...fadeIn} className={`bg-slate-50 dark:bg-slate-800 rounded-[2.5rem] p-10 border-t-8 border-t-${c.color}-500 shadow-sm hover:shadow-xl transition-all cursor-pointer h-full`}>
