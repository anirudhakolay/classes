      ...
      <section className="bg-slate-900 py-24 text-white text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeIn}>
            ...
            <h1 className="text-4xl md:text-6xl font-black mb-6">Wall of <span className="text-orange-500">Fame</span></h1>
            <p className="text-xl opacity-80 max-w-2xl mx-auto font-medium">Honouring the hard work, consistency, and brilliant success of our students.</p>
          </motion.div>
        </div>
      </section>
