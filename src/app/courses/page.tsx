    ...
    <main className="min-h-screen pt-20">
      ...
      <section className="py-24 bg-white dark:bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-12">
            {courses.map((c, i) => (
              <motion.div key={i} {...fadeIn} className={`bg-slate-50 dark:bg-slate-800 rounded-[2.5rem] p-10 border-t-8 border-t-${c.color}-500 shadow-sm hover:shadow-xl transition-all`}>
                ...
                <div className={`p-4 rounded-2xl bg-${c.color}-500/10 border border-${c.color}-500/20 text-${c.color}-600 dark:text-${c.color}-400 font-bold text-sm text-center mt-auto`}>
                  {c.feature}
                </div>
              </motion.div>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {competitive.map((exam, i) => (
              <motion.div key={i} {...fadeIn} className="bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700 hover:-translate-y-2 transition-all">
      ...
      <section className="py-24 bg-slate-900 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-5xl font-black mb-8">Secure Your Admission for 2026-27</h2>
